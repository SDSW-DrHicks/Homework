...
# which could be plotted as a function of time.
# Examples could be housing cost inflation, salaries for a certain job,
# or the change in the amount of atmospheric CO2 levels. Please
# provide links or citations of the data below (aim for at least 10 datapoints).
# (5 points)
# -------
...
#Problem 2d:
# Choose 2 values as inputs to your model (1 value as a prediction, 1 as a validation)
